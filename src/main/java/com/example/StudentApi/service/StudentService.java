...
public class StudentService implements IStudentService {
  ...
  public void updateStudent (Long id, StudentRequestResource requestResource) {
    ...
    StudentEntity studentEntityToBeUpdated = studentRepository.findById(id).orElseThrow(
        () -> new IllegalStateException(String.format(STUDENT_ID_NOT_FOUND, id)));
  ...
  public void deleteStudent (Long id) {
    ...
    if (studentToBeDeleted.isPresent()) {
      ...
      throw new IllegalStateException(String.format(STUDENT_CANNOT_BE_DELETED, id));
    }
  }
  ...
  public void deleteAllStudents () {
    ...
    if (!students.isEmpty()) {
      ...
      throw new IllegalStateException(MISSING_STUDENTS);
    }
  }
  ...
  private StudentEntity getStudentEntity (Long id) {
    ...
    return Optional.of(studentRepository.findById(id).get())
        .orElseThrow(() -> new IllegalStateException(String.format(STUDENT_ID_NOT_FOUND,id)));
  }
